          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10 text-center">
              {[
                ...
                { name: "Shogan", image: "/Images/shogan.png", bio: "Shogan est l’un des meilleurs lutteurs à sortir du Saguenay. Technicien et athlétique, il frappe fort et surprend souvent ses adversaires. Lorsqu’il monte dans le ring de la TUW, il livre toujours une performance solide et impressionnante." },

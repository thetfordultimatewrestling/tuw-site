        ...
        <section id="roster" className="py-24 px-6">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="space-y-8 mb-20">
              ...
              <div className="flex flex-col md:flex-row items-center bg-black/60 border border-red-600/40 backdrop-blur-md rounded-2xl p-6 shadow-xl">
                ...
                <div className="text-center md:text-left">
                  ...
                  <p className="text-gray-400">
                    ...
                    Il dirige maintenant La Classe Supérieure avec Dreya Mitchell, DGenerate et Mitch Thompson. Un clan qui, jusqu'à tout récemment, possèdait tous les titres de la compagnie.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row items-center bg-black/60 border border-red-600/40 backdrop-blur-md rounded-2xl p-6 shadow-xl">
                <img src="/Images/Roster_Tag_CHAMP_Chaud_Stoppers.png" alt="Champions par Équipe TUW" className="w-105 h-85 object-cover rounded-2xl mb-6 md:mb-0 md:mr-8"/>
                <div className="text-center md:text-left">
                  <h3 className="text-2xl font-bold mb-2">Champions par Équipe TUW</h3>
                  <p className="text-gray-400">
                    À Wild Ride III, les championnats par équipe de La Classe Supérieure étaient en jeu dans un combat de rue. Après des mois de détermination, Les Chaud Stoppers, SeXXXy Eddy et Carloss Gonzales, 
                    ont finalement atteint le sommet de la division par équipe. Alors que Mitch Thompson et DGenerate avaient neutralisé Eddy en l'attachant au coin du ring, un plan orchestré par Kacey Diamond est venu tout changer. 
                    Profitant de l'arrivée de Plein Goût à la TUW pour distraire La Classe Supérieure, Kacey a permis aux Chaud Stoppers de reprendre le contrôle du combat en détachant Eddy. 
                    Le tout s'est conclu de façon spectaculaire lorsque Carloss a écrasé DGenerate avec un Swanton Bomb du haut d'une échelle, offrant ainsi la victoire et les championnats aux Chaud Stoppers.                
                    </p>
                </div>
              </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10 text-center">
              {[
                ...
                { name: "Chase Ironside", image: "/Images/chase-ironside.png", bio: "Chase Ironside est un lutteur imposant et dominant, actif depuis les années 90 et ayant affronté les plus grands du Québec. Pionnier ayant contribué à faire tomber les barrières de la lutte et entrer dans la pop culture québécoise, il a frôlé le titre TUW à plusieurs reprises. À la TUW, il reste l’un des colosses du ring : lutter contre Chase, c’est comme frapper un mur." },
                { name: "Chester Doan", image: "/Images/chester-doan.png", bio: "Chester Doan est le roi de l’hydratation. À la surprise de plusieurs, ce vétéran de la lutte québécoise, actif depuis 2006, brille surtout dans les combats à grand nombre plutôt qu’en simple. Très agile, il mélange habilement technique, haute voltige et stratégie. Un lutteur comme lui se fait rare." },
                ...
                { name: "Dylan Donovan", image: "/Images/Dylan-Donovan.png", bio: "Dylan Donovan est un talent hors pair de la TUW, reconnu partout au Québec pour son charisme et sa capacité à faire réagir la foule. En équipe avec Yann Pike, il forme les Wonderboys, une équipe qui figure régulièrement parmi les meilleures formations de la province. Après une première apparition à la TUW en 2023, Dylan est maintenant officiellement membre du roster depuis l'arrivée fracassante de Plein Goût à Wild Ride III, où lui et Yann Pike sont intervenus aux côtés de Kacey Diamond pour s'en prendre à La Classe Supérieure." },
                ...
                { name: "Kacey Diamond", image: "/Images/Kacey-Diamond.png", bio: "Kacey Diamond, l'une des premières lutteuses à avoir fait partie de la TUW dès ses débuts, a fait son retour en même temps que celui de la compagnie en 2023. Après avoir quitté le Icon Club au début de 2025, elle s'est éloignée de la TUW jusqu'à son retour en avril 2026. Entre-temps, Kacey s'est imposée partout à travers le pays et revient à la TUW accompagnée de Dylan Donovan et Yann Pike pour former Plein Goût. Son objectif est clair : faire tomber La Classe Supérieure, mettre fin au règne de Dreya Mitchell et reprendre sa place au sommet en ramenant le diamant à la TUW." },
                ...
                { name: "Leon Saver", image: "/Images/leon-saver.png", bio: "Leon Saver est un vétéran de la scène québécoise ayant parcouru les promotions partout dans la province. Ancien membre de l’Icon Club, il combine agilité, force et une psychologie du ring redoutable. Stratège dans l’âme, Leon sait démolir ses adversaires pièce par pièce… et son expérience fait souvent toute la différence dans le ring." },
                ...
                { name: "Yann Pike", image: "/Images/Yann-Pike.png", bio: "Yann Pike est une présence unique à la TUW, reconnu partout au Québec pour son attitude, son énergie et son style explosif. Avec Dylan Donovan, il forme les Wonderboys, une équipe régulièrement citée parmi les meilleures formations de la province. Après une première apparition à la TUW, Yann est maintenant officiellement membre du roster depuis l'arrivée de Plein Goût à Wild Ride III aux côtés de Dylan Donovan et Kacey Diamond pour s'en prendre à La Classe Supérieure. " },

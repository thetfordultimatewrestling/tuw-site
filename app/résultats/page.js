          ...
          <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <div className="flex space-x-8 text-sm tracking-wide">
                ...
                <a href="/media" className="hover:text-red-400 transition">Résultats</a>
          ...
          {menuOpen && (
            <div className="md:hidden bg-black/95 backdrop-blur-lg border-t border-zinc-800">
              ...
              <div className="flex flex-col items-center space-y-6 py-8 text-lg">
                ...
                <a href="/roster" onClick={() => setMenuOpen(false)}>Résultats</a>
        ...
        <section className="pt-40 pb-24 px-6 text-center">
          <div className="max-w-4xl mx-auto backdrop-blur-xl bg-zinc-900/60 p-10 rounded-3xl border border-zinc-800 shadow-2xl">
            ...
            <p className="text-gray-300 text-lg leading-relaxed mb-6">
              ⭐Résultats TUW original Kickoff 2025⭐
📆 25 janvier 2025
📍 Studio Paul Hébert, Thetford Mines 
🖥️ Mike Marston nous annonce qu'il doit malheureusement remettre son titre TUW du à une blessure et sera absent pour une période indéterminée 😢 nous lui souhaitons prompt rétablissement! 🫶 
...
1️⃣ Chase Ironside bat Karl Jepson pour devenir officiellement aspirant au titre tel que mentionné plus tôt et ce à la grande déception de Tony Icon 🫠 
2️⃣ Carloss Gonzales conserve le championnat UWD contre le géant de St-Casimir Matt Falco. 
🖥️ Un tout nouveau concept est présenté aux spectateurs.  Le 'Lucky 7 Scramble' 🎰
...
3️⃣ Sexxxy Eddy gagne sa place dans le 
'Lucky 7 Scramble' en battant Jason Petitclerc 
4️⃣ Scott Matrix vient à bout de Mr.VIP Mitch Thompson malgré les interventions de Tony Icon aux abords du ring. 
▪️Les 2 membres du Icon Club attaquent Scott après le combat mais Mr.Brown effectue un retour et vient à sa rescousse! Un uppercut pour Mitch! un uppercut pour Tony!  Les gens sont content de voir ça 💪 
🎤 Mr.Brown prend ensuite la parole pour prédire la fin imminente du Icon Club 😳.
À suivre.. 
🖥️ Alors que Scott Matrix est encore dans le ring. Une vidéo mystérieuse annonçant le retour d'un lutteur est diffusé à l'écran.  On en sais pas plus pour l'instant 🤔 
🎤 Alors que le triple menace féminin s'apprêtait à commencer. Carlos s'amène au ring pour faire la cour aux jolies demoiselles dans l'arène.  Mais également pour offrir une chance à la gagnante d'avoir une 'date' avec lui ET une chance pour son titre UWD qu'il détient depuis plus d'un an! 
...Intéressant🌹 
5️⃣ Dreya Mitchell se sauve avec la victoire contre Kacey Diamond & Kristara dans un excellent match triple menace qui nous a bien démontré pourquoi ces 3 lutteuses font parti des meilleurs au Québec 👊 
🖥️  En backstage, Carloss s'empiffre de tout les tablettes de chocolat qu'il a pu trouver dans l'espoir de trouvé un billet d'or à l'intérieur.  Une fois endormi et si prêt du but. Carloss se fait volé le billet d'or caché dans la toute dernière tablette qui lui restait par une personne inconnu 🫨 
6️⃣ Muundo l'emporte contre Johnny Rush dans un 2 de 3 sans disqualification! 
🖥️ Le Racoon Jason Petitclerc frustré d'avoir perdu son match ce soir croise un Ziggy en pleine célébration d'avoir trouvé un billet d'or 👀.   Jason ne perd pas de temp à l'attaquer et quitté la salle avec son billet en main 🎫 
7️⃣ Les invincibles conservent les Championnats par équipe contre Capitaine Pezz et Jake Madison. 
▪️Les deux équipes se sert la main à la fin du combat.  Nous pensions finir cette soirée sur une note positive mais TDT (Mathieu St-Jacques & Thomas Dubois) en ont décidé autrement en attaquant les 2 équipes ainsi que le staff et les arbitres de la TUW. C'était un véritable carnage dans l'arène. Les 2 vétérans se sont acharnés sur la jambe du pauvre Marko Estrada avec une chaise et se sont sauvés avec les ceintures par équipes.   Des débuts remarqués pour TDT à la TUW c'est le moin qu'ont puissent dire!             
</p>

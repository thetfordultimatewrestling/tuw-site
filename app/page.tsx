...
>
  ...
  {/* Mobile Menu */}
  {menuOpen && (
    <div className="md:hidden bg-black/95 border-t border-zinc-800 px-6 py-6 space-y-6 text-center">
      ...
      <a href="#contact" onClick={() => setMenuOpen(false)} className="block text-lg hover:text-red-400">Contact</a>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="space-y-8 mb-20">
              ...
              <div className="flex flex-col md:flex-row items-center backdrop-blur-xl bg-zinc-900/90 border border-zinc-800 rounded-3xl p-6 shadow-xl">
                ...
                <div className="text-center md:text-left">
                  ...
                  <p className="text-gray-400">Marko Estrada, ancien des Invincibles avec Franky The Mobster, a trahi son partenaire en s’alliant secrètement à Tony Icon pour devenir champion de la TUW. Après avoir sécurisé sa chance au titre contre Buxx Belmar, il a remporté l’or, expulsé Tony et Scott Matrix, puis dissous le Icon Club. Il dirige maintenant La Classe Supérieure avec Dreya Mitchell, DGenerate et Mitch Thompson. Un clan qui possède tous les titres de la compagnie.</p>
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row items-center backdrop-blur-xl bg-zinc-900/90 border border-zinc-800 rounded-3xl p-6 shadow-xl">
                ...
                <div className="text-center md:text-left">
                  ...
                  <p className="text-gray-400">À Feast N’ Best 3, Marko Estrada a trahi son partenaire Franky The Mobster en plein combat contre Mitch Thompson et DGenerate, alors membres du Icon Club. Après deux splash dévastateurs sur Franky, Marko a quitté le ring, laissant FTM inconscient. Mitch et DGenerate en ont profité pour devenir champions par équipe de la TUW. Aujourd’hui, le Icon Club n’est plus, et Mitch ainsi que DGenerate font désormais partie de La Classe Supérieure aux côtés de Marko Estrada et Dreya Mitchell.</p>
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row items-center backdrop-blur-xl bg-zinc-900/90 border border-zinc-800 rounded-3xl p-6 shadow-xl">
                ...
                <div className="text-center md:text-left">
                  ...
                  <p className="text-gray-400">Le 22 mars 2025 à March Madness IX, Dreya Mitchell est devenue championne de la TUW en battant par surprise Carloss Gonzalez dans le combat le plus court de l’histoire de la TUW. Après avoir gagné son contrat à Original Kickoff face à Kacey Diamond et Kristara, elle a manipulé la situation pour frapper au moment parfait. Invaincue depuis novembre 2024, elle détient toujours le titre et la plus longue séquence de victoires de la compagnie. Elle fait partie du club de Marko Estrada, La Classe Supérieure aux côtés de Mitch Thompson et DGenerate.</p>
                </div>
              </div>
            ...
            <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-8 text-center">
              {[
                ...
                <div key={wrestler.name} className="group backdrop-blur-xl bg-zinc-900/60 p-6 rounded-3xl border border-zinc-800 shadow-xl hover:scale-105 transition duration-300">
